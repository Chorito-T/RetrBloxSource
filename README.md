...
> **Note:** RRS targets old Roblox builds and is not designed for current Roblox engine versions without modifications.
...
You can't use this if you in the build 2016, 2014, 2015, etc.
